    ...
    <Body style={main}>
      ...
      <Container style={container}>
        ...
        <Section style={productTitleTable}>
          <Text style={productsTitle}>Your Product</Text>
        </Section>
        <Section>
        ...
        <Section>
          <Row>
            <Column align="center" style={ctaTitle}>
              <Text style={ctaText}>Start Buying and Selling Digital Products on DIGISTORE for Free.</Text>
            </Column>
          </Row> 
        </Section>
        ...
        <Text style={footerCopyright}>
          Copyright © 2025 DIGISTORE Inc. <br />{' '}
